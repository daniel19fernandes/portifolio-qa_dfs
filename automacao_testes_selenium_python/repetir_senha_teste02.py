...
## REPETIR_SENHA_TESTE02 - Este teste consiste em verificar se o sistema submita quando o valor do campo "Senha" e Repita sua senha" são diferentes.
## Resultado esperado: TESTE INVÁLIDO (não há o submit)
