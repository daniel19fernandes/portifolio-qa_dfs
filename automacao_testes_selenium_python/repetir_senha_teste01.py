...
## REPETIR_SENHA_TESTE01 - Este teste consiste em verificar se o sistema submita quando o valor do campo "Senha" e Repita sua senha" são iguais.
## Resultado esperado: TESTE VÁLIDO (submitando com valores iguais)
